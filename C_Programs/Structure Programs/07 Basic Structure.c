...
int main()
{
    struct product obj1,obj2 = {24,"Bulb",70.80,120.00},obj3;
    ...
    scanf("%f",&obj3.P_price);

    printf("\n Enter product Selling Price => ");
    scanf("%d",&obj3.S_price);
    ...
    printf("\n\n 3rd Product Details Are =>");

    printf("\n\n product id =   %d",obj3.P_id);
    printf("\n Product Name = %s",obj3.P_Name);
    printf("\n Product purchase price = %0.2f",obj3.P_price);
    printf("\n Product Selling price  = %0.2f",obj3.S_price);
